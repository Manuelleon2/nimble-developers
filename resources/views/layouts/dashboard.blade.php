        ...
        <div class="contenedor-primario">
            ...
            <div class="contenedor-botones">
                <div class="contenedor-boton-pregunta">
                    <button id="botones-003" type="button" class="btn btn-success" data-mdb-toggle="modal"
                        data-mdb-target="#exampleModal">Preguntar</button>
                    ...
                    <button id="botones-003" type="button" class="btn btn-info" data-mdb-toggle="modal"
                        data-mdb-target="#exampleModal-adivinar">Adivinar</button>
                    <!--Modal adivinar-->
                    <div class="modal fade" id="exampleModal-adivinar" tabindex="-1"
                ...
                <div class="conten-button-adivinarYpreguntar">
                    <form action="{{ route('dashboard.preguntar', $id) }}" method="POST">
                        ...
                        <button id="botones-001" type="submit" class="btn btn-primary" data-mdb-toggle="modal"
                            data-mdb-target="#exampleModal-2">Terminar partida<i
